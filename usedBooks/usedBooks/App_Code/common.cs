...
namespace usedBooks.App_Code
{
    ...
    public static class common
    {
          ...
          if (myObject.GetType() == typeof(DropDownList))
            {
                ...
                if (string.IsNullOrEmpty(ddlMyObj.SelectedValue) || string.IsNullOrWhiteSpace(ddlMyObj.SelectedValue) || ddlMyObj.SelectedValue == string.Empty || ddlMyObj.SelectedValue=="0")
                {
                    ddlMyObj.Focus();
                    myLabel.ForeColor = System.Drawing.Color.Red;
        ...
        public static bool IsDecimalOrInt(string myString)
        {
            // this method applies for both int and decimal.
            decimal output;
            bool result = decimal.TryParse(myString, out output);
        ...
        public static string removeLastChar(string myString)
        {
    ...
    public class    clsCombo : DropDownList
    {
        //string mySql, DropDownList myCombo, string myValue,string  myText
