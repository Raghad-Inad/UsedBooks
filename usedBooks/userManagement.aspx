                                ...
                                <div class="row">
                                    <div class="col" > <center> 
                                        ...
                                        <asp:GridView ID="gvUserManagement" class="table table-striped table-bordered" runat="server" AutoGenerateColumns="False" DataKeyNames="userId" Height="250px" Width="802px"
                                            OnRowDeleting="gvUserManagement_RowDeleting" 
                                            OnRowEditing="gvUserManagement_RowEditing" 
                                            OnRowUpdating="gvUserManagement_RowUpdating" meta:resourcekey="gvDriverResource1" PageSize="20">
